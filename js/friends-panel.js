...
async function loadRealFriends(currentUser) {
    ...
    if (currentUser) {
        ...
        if (referralBox && !document.getElementById('btn-copy-referral')) {
            ...
            const btnHTML = `
                <button class="button-referral" id="btn-copy-referral" type="button">
                  ...
                  <div class="state state--default">
                    ...
                    <p>
                      <span style="--i:0">C</span><span style="--i:1">o</span><span style="--i:2">p</span><span style="--i:3">i</span><span style="--i:4">a</span><span style="--i:5">r</span><span style="--i:6">&nbsp;</span><span style="--i:7">L</span><span style="--i:8">i</span><span style="--i:9">n</span><span style="--i:10">k</span>
                    </p>
                  </div>
